...
class ClassPrinter : ClassVisitor(), AbstractPrinter<KotlinClassMetadata.Class> {
...
class LambdaPrinter : LambdaVisitor(), AbstractPrinter<KotlinClassMetadata.SyntheticClass> {
